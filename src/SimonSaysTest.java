...
public class SimonSaysTest extends KeyAdapter {
	...
	private void showImage() {
		...
		ssFrame.add(getNextRandomImage()); // 7. rename to the name of your frame

		// 8. set the size of the frame
		ssFrame.setSize(600, 600);

		// 9. add a key listener to the frame
		ssFrame.addKeyListener(this);
