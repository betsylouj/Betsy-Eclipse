...
public class FeedTheTortoise2Player implements KeyEventDispatcher
{
    ...
    private void checkIfFoodFound() throws Exception
    {
        ...
        double distance = Math.sqrt(Math.pow((tortoiseLocationX-foodLocationX),2)+Math.pow((tortoiseLocationY-foodLocationY),2));
if (distance<=30){
    ...
    private void moveFood()
    {
        ...
        window.add(food);
        System.out.println("X = " + foodLocationX + " Y = " + foodLocationY);
    }
